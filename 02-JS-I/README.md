...
- [JavaScript I](#javascript-i)
  ...
  - [Objetos Globales y métodos](#objetos-globales-y-métodos)
      - [Math.pow](#mathpow)
      - [Math.round, Math.floor, Math.ceil](#mathround-mathfloor-mathceil)
      - [.length](#length)
  ...
  - [Homework](#homework)
      - [Si tienes dudas sobre este tema, puedes consultarlas en el canal ***02_js-i*** de Slack](#si-tienes-dudas-sobre-este-tema-puedes-consultarlas-en-el-canal-02_js-i-de-slack)
