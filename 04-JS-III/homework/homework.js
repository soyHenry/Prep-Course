...
function promedioResultadosTest(resultadosTest) {
  ...
  let pro = suma / resultadosTest.length;
  return pro;
}  
...
function mesesDelAño(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    if(array[i] === e || array[i] === m || array[i] === n)
    agregarItemAlFinalDelArray(nuevoArreglo, array[i]);
  }
...
function mayorACien(array) {
  ...
  // Tu código:
  let mayor = array.filter(element => element > 100);
  return mayor;
}
